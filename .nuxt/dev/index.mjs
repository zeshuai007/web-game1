...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getHeader, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { eq, and, desc, sql } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/drizzle-orm/index.js';
import bcrypt from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/bcrypt/bcrypt.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/pathe/dist/index.mjs';
import jwt from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/jsonwebtoken/index.js';
import { drizzle } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/drizzle-orm/node-postgres/index.js';
import pg from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/pg/esm/index.mjs';
import { pgTable, timestamp, varchar, uuid, decimal, integer, uniqueIndex } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/drizzle-orm/pg-core/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/zeshuai007/claude/webgames/xianni-game/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/zeshuai007/claude/webgames/xianni-game/server/assets"}];
...
const _47home_47zeshuai007_47claude_47webgames_47xianni_45game_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/zeshuai007/claude/webgames/xianni-game","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/zeshuai007/claude/webgames/xianni-game/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47home_47zeshuai007_47claude_47webgames_47xianni_45game_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/home/zeshuai007/claude/webgames/xianni-game/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/home/zeshuai007/claude/webgames/xianni-game/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/zeshuai007/claude/webgames/xianni-game/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/zeshuai007/claude/webgames/xianni-game/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/zeshuai007/claude/webgames/xianni-game/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {},
  "jwtSecret": "xianni-dev-secret-change-in-production",
  "dbConnectionString": "postgresql://localhost:5433/xianni_game"
};
const envOptions = {
  prefix: "NITRO_",
...
const _vBiEh8lmH81GQWdw6EzWV_P_CDAw6jrwzjRfvlsNHY = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/zeshuai007/claude/webgames/xianni-game";
...
const _7q40c04ifgYsJlQwW0Z0bMgbHEDBIxTPAewREnd4U = (nitroApp) => {
...
const plugins = [
  _vBiEh8lmH81GQWdw6EzWV_P_CDAw6jrwzjRfvlsNHY,
_7q40c04ifgYsJlQwW0Z0bMgbHEDBIxTPAewREnd4U,
...
const _gOspPi = eventHandler((event) => {
...
const _Qdx7uz = defineEventHandler(async (event) => {
...
const _lazy_Z05fk4 = () => Promise.resolve().then(function () { return inventory_get$1; });
...
const handlers = [
  ...
  { route: '/api/inventory', handler: _lazy_Z05fk4, lazy: true, middleware: false, method: "get" },
...
const list_get = defineEventHandler(async (event) => {
  ...
  const recipes = [
    ...
    { id: "taiyi_dan", name: "\u592A\u4E59\u4E39", type: "cultivation", realm: "\u5143\u5A74\u671F", materials: [{ name: "\u9F99\u6D8E\u679C", id: "longxian_guo", quantity: 2 }, { name: "\u5BD2\u9AD3\u53F6", id: "hansui_ye", quantity: 4 }], cost: 3e3, effect: "\u4FEE\u70BC\u901F\u5EA6 +35%" },
    { id: "tianyun_dan", name: "\u5929\u97F5\u4E39", type: "cultivation", realm: "\u5316\u795E\u671F", materials: [{ name: "\u9F99\u6D8E\u679C", id: "longxian_guo", quantity: 3 }, { name: "\u4E07\u5E74\u7075\u829D", id: "wannian_lingzhi", quantity: 2 }], cost: 1e4, effect: "\u4FEE\u70BC\u901F\u5EA6 +40%" },
    { id: "xuanyuan_dan", name: "\u7384\u5143\u4E39", type: "cultivation", realm: "\u5A74\u53D8\u671F", materials: [{ name: "\u4E07\u5E74\u7075\u829D", id: "wannian_lingzhi", quantity: 3 }, { name: "\u4E03\u5F69\u96EA\u83B2", id: "qicai_xuelian", quantity: 2 }], cost: 5e4, effect: "\u4FEE\u70BC\u901F\u5EA6 +45%" },
    { id: "wendao_dan", name: "\u95EE\u9053\u4E39", type: "cultivation", realm: "\u95EE\u9F0E\u671F", materials: [{ name: "\u4E03\u5F69\u96EA\u83B2", id: "qicai_xuelian", quantity: 4 }, { name: "\u4E07\u5E74\u7075\u829D", id: "wannian_lingzhi", quantity: 4 }], cost: 2e5, effect: "\u4FEE\u70BC\u901F\u5EA6 +50%" },
    // Breakthrough pills
    ...
    { id: "qingyun_dan", name: "\u9752\u4E91\u4E39", type: "breakthrough", realm: "\u7ED3\u4E39\u2192\u5143\u5A74", materials: [{ name: "\u9F99\u6D8E\u679C", id: "longxian_guo", quantity: 2 }, { name: "\u5BD2\u9AD3\u53F6", id: "hansui_ye", quantity: 3 }], cost: 2e3, effect: "\u7A81\u7834\u6982\u7387 +20%" },
    { id: "huashen_dan", name: "\u5316\u795E\u4E39", type: "breakthrough", realm: "\u5143\u5A74\u2192\u5316\u795E", materials: [{ name: "\u9F99\u6D8E\u679C", id: "longxian_guo", quantity: 3 }, { name: "\u4E07\u5E74\u7075\u829D", id: "wannian_lingzhi", quantity: 1 }], cost: 8e3, effect: "\u7A81\u7834\u6982\u7387 +20%" },
    { id: "yingbian_dan", name: "\u5A74\u53D8\u4E39", type: "breakthrough", realm: "\u5316\u795E\u2192\u5A74\u53D8", materials: [{ name: "\u4E07\u5E74\u7075\u829D", id: "wannian_lingzhi", quantity: 2 }, { name: "\u4E03\u5F69\u96EA\u83B2", id: "qicai_xuelian", quantity: 1 }], cost: 3e4, effect: "\u7A81\u7834\u6982\u7387 +20%" },
    { id: "wending_dan", name: "\u95EE\u9F0E\u4E39", type: "breakthrough", realm: "\u5A74\u53D8\u2192\u95EE\u9F0E", materials: [{ name: "\u4E03\u5F69\u96EA\u83B2", id: "qicai_xuelian", quantity: 3 }, { name: "\u4E07\u5E74\u7075\u829D", id: "wannian_lingzhi", quantity: 3 }], cost: 1e5, effect: "\u7A81\u7834\u6982\u7387 +20%" }
  ];
  return { recipes };
});
...
const recipeCosts = {
  ...
  taiyi_dan: { materials: { longxian_guo: 2, hansui_ye: 4 }, cost: 3e3 },
  tianyun_dan: { materials: { longxian_guo: 3, wannian_lingzhi: 2 }, cost: 1e4 },
  xuanyuan_dan: { materials: { wannian_lingzhi: 3, qicai_xuelian: 2 }, cost: 5e4 },
  wendao_dan: { materials: { qicai_xuelian: 4, wannian_lingzhi: 4 }, cost: 2e5 },
  zhuji_dan: { materials: { youhun_cao: 3, ningxue_hua: 2 }, cost: 100 },
  tianli_dan: { materials: { ningxue_hua: 4, longxian_guo: 1 }, cost: 500 },
  qingyun_dan: { materials: { longxian_guo: 2, hansui_ye: 3 }, cost: 2e3 },
  huashen_dan: { materials: { longxian_guo: 3, wannian_lingzhi: 1 }, cost: 8e3 },
  yingbian_dan: { materials: { wannian_lingzhi: 2, qicai_xuelian: 1 }, cost: 3e4 },
  wending_dan: { materials: { qicai_xuelian: 3, wannian_lingzhi: 3 }, cost: 1e5 }
};
const refine_post = defineEventHandler(async (event) => {
  const userId = event.context.userId;
  const body = await readBody(event);
  const { pillType } = body || {};
  if (!pillType || !pillTypeEnum.includes(pillType)) {
  ...
  await db.update(characters).set({ lingshi: String(parseFloat(char.lingshi) - recipe.cost), updatedAt: /* @__PURE__ */ new Date() }).where(eq(characters.id, char.id));
  for (const [materialId, qty] of Object.entries(recipe.materials)) {
    const [inv] = await db.select().from(inventory).where(and(
      eq(inventory.characterId, char.id),
      eq(inventory.itemId, materialId)
    ));
    if (!inv || inv.quantity < qty) {
      await db.update(characters).set({ lingshi: String(parseFloat(char.lingshi)), updatedAt: /* @__PURE__ */ new Date() }).where(eq(characters.id, char.id));
      throw createError({ statusCode: 400, message: `\u6750\u6599\u4E0D\u8DB3\uFF1A${materialId}` });
    }
    await db.update(inventory).set({ quantity: inv.quantity - qty, updatedAt: /* @__PURE__ */ new Date() }).where(eq(inventory.id, inv.id));
  }
  const [existingPill] = await db.select().from(inventory).where(and(
    eq(inventory.characterId, char.id),
    eq(inventory.itemId, pillType),
    eq(inventory.itemType, "pill")
  ));
  if (existingPill) {
    await db.update(inventory).set({ quantity: existingPill.quantity + 1, updatedAt: /* @__PURE__ */ new Date() }).where(eq(inventory.id, existingPill.id));
  } else {
...
const refine_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: refine_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const breakthrough_post = defineEventHandler(async (event) => {
  ...
  const userId = event.context.userId;
  const body = await readBody(event);
  const usePill = !!(body == null ? void 0 : body.usePill);
  const db = useDB();
  const [char] = await db.select().from(characters).where(eq(characters.userId, userId));
  if (!char) {
    throw createError({ statusCode: 404, message: "\u89D2\u8272\u4E0D\u5B58\u5728" });
  ...
  if (!isMaxLayer(currentRealm, char.realmLayer)) {
    ...
    }).where(eq(characters.id, char.id)).returning();
  ...
  if (usePill) {
    ...
    if (pillKey) {
      const [inv] = await db.select().from(inventory).where(eq(inventory.characterId, char.id)).where(eq(inventory.itemId, pillKey)).limit(1);
      if (inv && inv.quantity > 0) {
        hasPill = true;
        await db.update(inventory).set({ quantity: inv.quantity - 1, updatedAt: /* @__PURE__ */ new Date() }).where(eq(inventory.id, inv.id));
      }
    }
  }
  const success = breakthroughRoll(currentRealm, hasPill);
  const baseChance = (_a = breakthroughBaseChance[`${currentRealm}\u2192${nextRealm}`]) != null ? _a : 0.15;
  if (success) {
...
function getBreakthroughPillForRealm(realm) {
  const map = {
...
const inventory_get = defineEventHandler(async (event) => {
  const userId = event.context.userId;
  const db = useDB();
  const [char] = await db.select().from(characters).where(eq(characters.userId, userId));
  if (!char) {
  ...
  const items = await db.select().from(inventory).where(eq(inventory.characterId, char.id));
  const mapped = items.map((item) => ({
    ...item,
    name: item.itemType === "pill" ? pillNames[item.itemId] || item.itemId : materialNames[item.itemId] || item.itemId
  }));
  return { items: mapped };
});

const inventory_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: inventory_get
}, Symbol.toStringTag, { value: 'Module' }));

const rankings_get = defineEventHandler(async () => {
  const db = useDB();
  ...
  return {
    rankings: rankings.map((r, idx) => ({
      rank: idx + 1,
      nickname: r.nickname,
      realm: realmLabels[r.realm] || r.realm,
...
const rankings_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: rankings_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const buy_post = defineEventHandler(async (event) => {
  ...
  await db.update(characters).set({ lingshi: String(parseFloat(char.lingshi) - price), updatedAt: /* @__PURE__ */ new Date() }).where(eq(characters.id, char.id));
  const [existing] = await db.select().from(inventory).where(and(
    eq(inventory.characterId, char.id),
    eq(inventory.itemId, itemId)
  ));
  if (existing) {
    await db.update(inventory).set({ quantity: existing.quantity + quantity, updatedAt: /* @__PURE__ */ new Date() }).where(eq(inventory.id, existing.id));
  } else {
    await db.insert(inventory).values({
      characterId: char.id,
      itemType: "material",
...
const items_get = defineEventHandler(async () => {
  const items = [
    ...
    { id: "qicai_xuelian", name: "\u4E03\u5F69\u96EA\u83B2", type: "material", description: "\u4F20\u8BF4\u7EA7\u836F\u6750\uFF0C\u9876\u7EA7\u4E39\u836F\u6240\u9700", price: 2e3 }
  ];
  return { items };
});
