declare global {
  ...
  const breakthroughBaseChance: typeof import('../../server/utils/game-engine').breakthroughBaseChance
  const breakthroughRoll: typeof import('../../server/utils/game-engine').breakthroughRoll
  const cachedEventHandler: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache').cachedEventHandler
  const cachedFunction: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache').cachedFunction
  const calcOfflineEarnings: typeof import('../../server/utils/game-engine').calcOfflineEarnings
  ...
  const getMaxLayer: typeof import('../../server/utils/game-engine').getMaxLayer
  const getMethod: typeof import('../../node_modules/h3').getMethod
  const getNextRealm: typeof import('../../server/utils/game-engine').getNextRealm
  const getPillBreakthroughBonus: typeof import('../../server/utils/game-engine').getPillBreakthroughBonus
  const getPillCultivationBonus: typeof import('../../server/utils/game-engine').getPillCultivationBonus
  ...
  const isMaxLayer: typeof import('../../server/utils/game-engine').isMaxLayer
  const isMethod: typeof import('../../node_modules/h3').isMethod
  const isPreflightRequest: typeof import('../../node_modules/h3').isPreflightRequest
  const isStream: typeof import('../../node_modules/h3').isStream
  const isWebResponse: typeof import('../../node_modules/h3').isWebResponse
  const lazyEventHandler: typeof import('../../node_modules/h3').lazyEventHandler
  const materialNames: typeof import('../../server/utils/game-engine').materialNames
  const nitroPlugin: typeof import('../../node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  const parseCookies: typeof import('../../node_modules/h3').parseCookies
  const pillNames: typeof import('../../server/utils/game-engine').pillNames
